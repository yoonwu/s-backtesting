...
<div class="card"><div class="eyebrow">파라미터</div>
 <div class="controls">
  <div class="ctl"><label>추세 이동평균 <output id="o-ma">169</output>일</label>
   <input type="range" id="p-ma" min="50" max="300" step="1" value="169"></div>
 ...
 <div class="btnrow">
  ...
  <button onclick="preset()">운영값 리셋 (MA169 · 32/36 · ±0.5%)</button>
 </div>
</div>
...
function preset(){ $('p-ma').value=169;$('p-vin').value=32;$('p-vout').value=36;$('p-buf').value=0.5;
