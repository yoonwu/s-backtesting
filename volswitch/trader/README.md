...
- 예외매수: 현금 상태에서 (QQQ<400일선 & RSI14<30) 또는 고점대비 −40% → 전량 매수 후
  정규 신호 재점등까지 보유. 오너 확정(2026-07): 무손절(EXCEPTION_STOP=0) — 예외 포지션은 진성 B&H.
  (EXCEPTION_STOP=0.30은 QE세계 발동 0회의 인계철선 옵션으로 코드에 존치)
