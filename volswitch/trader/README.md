...
- 정규(히스테리시스): 진입 QQQ>MA169×1.005 & vol<32% / 청산 QQQ<MA169×0.995 or vol>36%
  - 오너 확정(2026-07-16, 개정): MA 150→169 — 근거: 1일 단위 전수조사(5,271조합, 2010~ 실측)
    원값 3위(1.007, 1위와 0.007차)이며 vol축 불변. 이웃 MA163~184 × vol32~34 전체가
    MAR 0.95~1.01 능선으로 확인(침봉 아님). CAGR 40.5→43.6%, MDD −45.7→−43.3%.
- 예외매수: 현금 상태에서 (QQQ<400일선 & RSI14<30) 또는 고점대비 −40% → 전량 매수,
  이후 ① 정규 신호 재점등 시 인계 또는 ② 매수가 대비 추가 −30% 손절 + 정규 사이클까지 재발동 금지.
  오너 확정(2026-07-16, 개정): EXCEPTION_STOP=0.30 — 근거: 3세계 약우위(V자 발동0회·GFC 0.45→0.72·
  닷컴 0.19→0.52), 역대 손절 3건 모두 손절가보다 낮은 레벨에서 재진입. -20 이하는 V자 오발동 절벽으로 금지.
